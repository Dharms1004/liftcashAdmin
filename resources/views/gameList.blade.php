                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Games list</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button type="button" data-offer-id="{{ $gamedata->id }}" class="btn btn-block btn-success btn-sm">Active</button></td>
                                                @elseif($gamedata->status == 2)
                                                <td><button type="button" data-offer-id="{{ $gamedata->id }}" class="btn btn-block btn-danger btn-sm">Inactive</button></td>
