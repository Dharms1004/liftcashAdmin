                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Total Converted Offer</span>
                                    <span class="info-box-number">
                                        {{ $totalConvertedoffer }}
                                        {{-- <small>%</small> --}}
                                    </span>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Today Offer Converted</span>
                                    <span class="info-box-number">{{ $totalConvertedOfferToday }}</span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
